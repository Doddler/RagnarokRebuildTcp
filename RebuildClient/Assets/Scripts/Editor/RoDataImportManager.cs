...
namespace Scripts.Editor
{
    public class GrfDataFilesCategorized
    {
        ...
        public readonly RoFilesList SoundFiles = new();
        public readonly RoFilesList MonsterFiles = new();
        public readonly RoFilesList HeadFiles = new();
        public readonly RoFilesList BodyFiles = new();
        public readonly RoFilesList HeadgearFiles = new();
        public readonly RoFilesList WeaponFiles = new();
        public readonly RoFilesList ShieldFiles = new();
        public readonly RoFilesList NpcFiles = new();
        public readonly RoFilesList PaletteFiles = new();
        public readonly RoFilesList CutinFiles = new();
        public readonly RoFilesList MiscFiles = new();

        public string this[int index]
        {
            get
            {
                return categoriesDict.Keys.ToArray()[index];
            }
        }
        ...
        public int Count
        {
            get
            {
                return Categories.Aggregate(0, (acc, cur) => acc + cur.Count);
            }
        }
    ...
    public static class RoDataImportManager // Open to suggestions on this name
    {
        ...
        public static GrfDataFilesCategorized ReadGrfDataFolder(string inputDataPath = null)
        {
            ...
            {
                {(int)RagnarokDirectory.ActDirectoriesID.ActMonstersDirectories, grfData.MonsterFiles},
                {(int)RagnarokDirectory.ActDirectoriesID.ActPlayerHeadDirectories, grfData.HeadFiles},
                {(int)RagnarokDirectory.ActDirectoriesID.ActPlayerBodyDirectories, grfData.BodyFiles},
                {(int)RagnarokDirectory.ActDirectoriesID.ActPlayerHeadgearDirectories, grfData.HeadgearFiles},
                {(int)RagnarokDirectory.ActDirectoriesID.ActWeaponsDirectories, grfData.WeaponFiles},
                {(int)RagnarokDirectory.ActDirectoriesID.ActShieldsDirectories, grfData.ShieldFiles},
                {(int)RagnarokDirectory.ActDirectoriesID.ActNpcDirectories, grfData.NpcFiles}
            };
        ...
        public static void ConvertToAsset(string actFilePath, string assetDirectoryPath = null)
        {
            ...
            var sprFilePath = DoesSprExist(actFilePath);
        ...
        {
            //Check for .spr pair immediately, otherwise quit the import
            var sprFilePath = actFilePath.Replace(".act", ".spr");
            if (!File.Exists(sprFilePath))
            {
