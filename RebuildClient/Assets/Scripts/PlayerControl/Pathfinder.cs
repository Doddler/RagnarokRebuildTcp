...
namespace Assets.Scripts
{
    ...
    public static class Pathfinder
    {
        ...
        public static bool HasLineOfSight(Vector2Int pos1, Vector2Int pos2)
        {
            var provider = CameraFollower.Instance.WalkProvider;
            if (provider == null || provider.WalkData == null)
                return false;
            ...
            for (; ; )
            {
                ...
                if (provider.WalkData.DoesCellBlockLos(x0, y0))
                    return false;
                var e2 = err;
