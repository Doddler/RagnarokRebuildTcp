...
public class ColorPicker : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    private void Update()
    {
        ...
        image.materialForRendering.SetFloat(_AspectRatio, rect.width / rect.height);
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        {
            var size = image.materialForRendering.GetFloat(_SVSquareSize);
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        if (r < .5f && r > image.materialForRendering.GetFloat(_HueCircleInner))
        {
    ...
    {
        image.materialForRendering.SetVector(_HSV, new Vector3(h, s, v));
