...
* Effects appear as white rectangles: Run 'Import and Update Skill Effect Atlas' from the Ragnarok menu.
* Items don't appear correctly, or you receive item sprite related errors when logging in: Run 'Import Skill and Item Icons' from the Ragnarok menu.
